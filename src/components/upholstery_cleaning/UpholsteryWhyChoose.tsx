                ...
                <div className="max-w-[600px] relative z-10 w-full">
                    ...
                    <div className="space-y-0">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="flex items-center gap-4 py-8 border-b border-gray-400 last:border-0"
                                data-aos="fade-left"
                            ...
                            >
                                ...
                                <p className="text-[#304462] font-medium text-[16px] md:text-[18px]">
                                    {feature.title}
                                </p>
                            </div>
                        ))}
                    ...
                    <p className="mt-12 text-[#4b5563] text-[15px] italic opacity-90 max-w-[500px] leading-relaxed">
