    ...
    return (
        <section className="w-full py-12 md:py-24 bg-white">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
                <h2 className="text-[#304462] font-display font-regular text-[36px] md:text-[52px] text-center mb-12 md:mb-24">
                    How It Works
                </h2>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 lg:gap-10 px-[15px] md:px-[12px] lg:px-[20px]">
                    {steps.map((step, index) => (
                        <div key={index} className="flex flex-col items-start group" data-aos="fade-up" data-aos-delay={index * 150}>
                            ...
                            <div className="w-full">
                                <p className="text-[#304462] text-[14px] leading-snug md:leading-relaxed mb-4">
                                    <span className="font-bold">{step.title} —</span> {step.description}
                                </p>
                                {/* Bottom Line */}
                                <div className="w-full h-[1.5px] bg-[#304462] opacity-[0.5] md:opacity-40" />
                            </div>
                        </div>
                    ))}
                </div>
